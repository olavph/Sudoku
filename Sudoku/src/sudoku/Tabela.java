...
public class Tabela {
    ...
    //retorna as casas do quadrante quadr passado como parâmetro
    ...
    //seta o valor numerico n de uma casa na posicao (i,j)
    public void setCasa(int n, int i, int j) {
        casas[i][j].setNumero(n);
    }

    //retorna um valor numerico n de uma casa na posicao (i,j)
